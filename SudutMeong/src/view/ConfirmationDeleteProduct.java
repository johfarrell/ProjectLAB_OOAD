...
public class ConfirmationDeleteProduct implements ActionListener{
	 ...
	 */
	public ConfirmationDeleteProduct(Integer ProductID) {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Are you sure you want to delete this product ?");
