...
public class ConfirmationFire implements ActionListener {
	 ...
	 */
	public ConfirmationFire(Integer EmployeeID) {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Are you sure you want to fire this employee ?");
